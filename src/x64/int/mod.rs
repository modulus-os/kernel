...
// IDT must be static so it outlives init() -- a stack-allocated IDT gets
// freed on return and the first interrupt would triple-fault.
static mut IDT: [Entry; 256] = [Entry::new(0x0, 0x0, 0x0); 256];
